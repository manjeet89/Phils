...
//        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog=new Dialog(Job_Category_Activity.this);
...
//        String [] items = withoutQuotes_line1.split("\\s*,\\s*");
        ...
        String addjobcategory = "";

        for (int i =0;i<items.length;i++) {

            if (items[i].equals("add-job-category")) { addjobcategory = "add-job-category"; }
        }
        if(addjobcategory.equals("add-job-category")){
        ...
        private void recycleClickLister() {
            listener = new JobCategoryAdapterClass.RecycleViewClickListener() {
                ...
                public void onClick(View v, int position) {
                    ...
                    String updatejobcategory = "";

                    for (int i =0;i<items.length;i++) {

                        if (items[i].equals("update-job-category")) { updatejobcategory = "update-job-category"; }
                    }
                    if(updatejobcategory.equals("update-job-category")){
                        add.setVisibility(View.VISIBLE);
                    }
                    else
                    {
                        add.setVisibility(View.GONE);
                        Toast.makeText(Job_Category_Activity.this, "No Access Available", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
