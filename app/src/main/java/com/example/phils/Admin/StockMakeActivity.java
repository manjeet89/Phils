...
//        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog=new Dialog(StockMakeActivity.this);
                ...
                logout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        appConfig.updateUserLoginStatus(false);
                        startActivity(new Intent(StockMakeActivity.this,LoginActivity.class));
                        finish();
                    }
                });
...
//        String [] items = withoutQuotes_line1.split("\\s*,\\s*");
        ...
        for (int i =0;i<items.length;i++) {
            ...
            if (items[i].equals("add-stock-make")) { addmake = "add-stock-make"; }
        }
        if(addmake.equals("add-stock-make")){
    ...
    private void fatchdata() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://erp.philsengg.com/api/stock/stock_make",
    ...
    private void recycleClickLister() {
        listener = new StockMakeAdapterClass.RecycleViewClickListener() {
            ...
            public void onClick(View v, int position) {
                ...
                Dialog  dialog=new Dialog(StockMakeActivity.this);
                ...
                String updatestockmake = "";

                for (int i =0;i<items.length;i++) {

                    if (items[i].equals("update-stock-make")) { updatestockmake = "update-stock-make"; }
                }
                if(updatestockmake.equals("update-stock-make")){
                    add.setVisibility(View.VISIBLE);
                }
                else
                {
                    add.setVisibility(View.GONE);
                    Toast.makeText(StockMakeActivity.this, "No Access Available", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
