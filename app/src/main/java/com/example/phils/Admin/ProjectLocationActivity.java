        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                logout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        appConfig.updateUserLoginStatus(false);
                        startActivity(new Intent(ProjectLocationActivity.this,LoginActivity.class));
                        finish();
                    }
                });
...
//
        ...
        String locationIds  = appConfig.getLocationId();
        select_location.setText(locationName);
        setlocation.setText(locationIds);
