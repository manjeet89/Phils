...
//        String [] items = withoutQuotes_line1.split("\\s*,\\s*");
        ...
        for (int i =0;i<items.length;i++) {
            ...
            if (items[i].equals("add-stock")) { addstock = "add-stock"; }
        }
        if(addstock.equals("add-stock")){
            stock_add_button.setVisibility(View.VISIBLE);
        }
        else
        {
            stock_add_button.setVisibility(View.GONE);
        }
    ...
    private void recycleClickLister() {
        listener = new StockListAdapterClass.RecycleViewClickListener() {
            ...
            public void onClick(View v, int position) {
                ...
                String updatestock = "",transferstock="",deletestock="";

                for (int i =0;i<items.length;i++) {

                    if (items[i].equals("update-stock")) { updatestock = "update-stock"; }
                    if (items[i].equals("transfer-stock")) { transferstock = "transfer-stock"; }
                    if (items[i].equals("delete-stock")) { deletestock = "delete-stock"; }

                }
                if(updatestock.equals("update-stock")){
                ...
                if(transferstock.equals("transfer-stock")){
                ...
                if(deletestock.equals("delete-stock")){
