...
//        }
        ...
        String access_module = appConfig.getaccess_module();
        ...
        for (int i =0;i<items.length;i++) {
            ...
            if (items[i].equals("add-stock-type")) { addtype = "add-stock-type"; }
        }
        if(addtype.equals("add-stock-type")){
...
//
    ...
    private void fatchdata() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://erp.philsengg.com/api/stock/stock_type",
