...
public class RequisitionReciverAdapterClass extends RecyclerView.Adapter<RequisitionReciverAdapterClass.MyViewHolder> {

    private RequisitionReciverAdapterClass.RecycleViewClickListener listener;
    private List<ResponseModelRequisitionReiverOnGoing> data;

    public RequisitionReciverAdapterClass(RecycleViewClickListener listener, List<ResponseModelRequisitionReiverOnGoing> data) {
        this.listener = listener;
        this.data = data;
    }

    public void setFilteredList(List<ResponseModelRequisitionReiverOnGoing> filteredList)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_requisition_reciver_list,parent,false);
